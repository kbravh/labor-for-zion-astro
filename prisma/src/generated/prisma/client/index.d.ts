...
export namespace Prisma {
  ...
  */
	...
	> = {
		 ...
		 */
		orderBy?:
			| AnalyticsOrderByWithRelationInput
			| AnalyticsOrderByWithRelationInput[];
		/**
	...
	> {
		...
		createManyAndReturn<T extends AnalyticsCreateManyAndReturnArgs>(
			args?: SelectSubset<T, AnalyticsCreateManyAndReturnArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$AnalyticsPayload<ExtArgs>,
				T,
		...
		updateManyAndReturn<T extends AnalyticsUpdateManyAndReturnArgs>(
			args: SelectSubset<T, AnalyticsUpdateManyAndReturnArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$AnalyticsPayload<ExtArgs>,
				T,
		...
		>(
			args: SubsetIntersection<T, AnalyticsGroupByArgs, OrderByArg> &
				InputErrors,
		): {} extends InputErrors
	...
	interface AnalyticsFieldRefs {
		...
		readonly slug: FieldRef<"Analytics", "String">;
		readonly locale: FieldRef<"Analytics", "String">;
		readonly utm_source: FieldRef<"Analytics", "String">;
		readonly utm_medium: FieldRef<"Analytics", "String">;
		readonly utm_campaign: FieldRef<"Analytics", "String">;
		readonly utm_content: FieldRef<"Analytics", "String">;
		readonly utm_term: FieldRef<"Analytics", "String">;
		readonly referrer: FieldRef<"Analytics", "String">;
		readonly screenResolution: FieldRef<"Analytics", "String">;
	...
	> = {
		 ...
		 */
		data: XOR<
			AnalyticsUpdateManyMutationInput,
			AnalyticsUncheckedUpdateManyInput
		>;
		/**
	...
	export type AnalyticsWhereInput = {
		...
		slug?: StringFilter<"Analytics"> | string;
		locale?: StringFilter<"Analytics"> | string;
		utm_source?: StringNullableFilter<"Analytics"> | string | null;
		utm_medium?: StringNullableFilter<"Analytics"> | string | null;
		utm_campaign?: StringNullableFilter<"Analytics"> | string | null;
		utm_content?: StringNullableFilter<"Analytics"> | string | null;
		utm_term?: StringNullableFilter<"Analytics"> | string | null;
		referrer?: StringNullableFilter<"Analytics"> | string | null;
		screenResolution?: StringNullableFilter<"Analytics"> | string | null;
	...
	export type AnalyticsScalarWhereWithAggregatesInput = {
		...
		slug?: StringWithAggregatesFilter<"Analytics"> | string;
		locale?: StringWithAggregatesFilter<"Analytics"> | string;
		utm_source?:
			| StringNullableWithAggregatesFilter<"Analytics">
			| string
			| null;
		utm_medium?:
			| StringNullableWithAggregatesFilter<"Analytics">
		...
		utm_content?:
			...
			| string
			| null;
		utm_term?: StringNullableWithAggregatesFilter<"Analytics"> | string | null;
