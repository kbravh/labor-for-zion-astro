...
C.comparedTo = C.cmp = function (e) {
	var t,
		...
		f = e.s;
	if (!s || !a)
		return !l || !f ? Number.NaN : l !== f ? l : s === a ? 0 : !s ^ (l < 0) ? 1 : -1;
...
C.minus = C.sub = function (e) {
	...
	if (
		((f = this.d), (v = e.d), (a = A.precision), (l = A.rounding), !f[0] || !v[0])
	) {
		if (v[0]) e.s = -e.s;
...
C.plus = C.add = function (e) {
	...
	if (((e = new v(e)), !this.d || !e.d))
		return (
			!this.s || !e.s
				? (e = new v(Number.NaN))
				: this.d || (e = new v(e.d || this.s === e.s ? this : Number.NaN)),
			e
		);
...
C.precision = C.sd = function (e) {
	...
	return (
		this.d ? ((t = po(this.d)), e && this.e + 1 > t && (t = this.e + 1)) : (t = Number.NaN), t
	);
};
C.round = function () {
	var 
...
C.squareRoot = C.sqrt = function () {
	var e,
		...
		g = this.constructor;
	if (f !== 1 || !a || !a[0])
		return new g(!f || (f < 0 && (!a || a[0])) ? Number.NaN : a ? this : 1 / 0);
	for (
		_ = !1,
			f = Math.sqrt(+this),
			f == 0 || f == 1 / 0
...
function yo(e) {
	...
	function i(o) {
		...
		if (l === "bigint")
			return o < 0 ? ((o = -o), (this.s = -1)) : (this.s = 1), fr(this, o.toString());
		throw Error(Ie + o);
	}
	if (
		((i.prototype = C),
