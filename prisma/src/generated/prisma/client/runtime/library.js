...
m.comparedTo = m.cmp = function (e) {
	var r,
		...
		u = e.s;
	if (!s || !a)
		return !l || !u ? Number.NaN : l !== u ? l : s === a ? 0 : !s ^ (l < 0) ? 1 : -1;
...
m.minus = m.sub = function (e) {
	...
	if (
		((u = this.d), (d = e.d), (a = g.precision), (l = g.rounding), !u[0] || !d[0])
	) {
		if (d[0]) e.s = -e.s;
...
m.precision = m.sd = function (e) {
	...
	return (
		this.d ? ((r = Qs(this.d)), e && this.e + 1 > r && (r = this.e + 1)) : (r = Number.NaN), r
	);
};
m.round = function () {
	var 
...
m.squareRoot = m.sqrt = function () {
	var e,
		...
		c = this.constructor;
	if (u !== 1 || !a || !a[0])
		return new c(!u || (u < 0 && (!a || a[0])) ? Number.NaN : a ? this : 1 / 0);
	for (
		w = !1,
			u = Math.sqrt(+this),
			u == 0 || u == 1 / 0
...
function Je(e, r) {
	...
	if (
		...
		while ((n < 7 && n != 1) || (n == 1 && t.charAt(1) > 3))
...
function Ys(e) {
	...
	function i(o) {
		...
		if (l === "bigint")
			return o < 0 ? ((o = -o), (this.s = -1)) : (this.s = 1), ln(this, o.toString());
		throw Error(He + o);
	}
	if (
		((i.prototype = m),
