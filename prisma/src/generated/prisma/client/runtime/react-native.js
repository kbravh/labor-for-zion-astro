...
S.precision = S.sd = function (e) {
	...
	return (
		this.d ? ((t = uo(this.d)), e && this.e + 1 > t && (t = this.e + 1)) : (t = Number.NaN), t
	);
};
S.round = function () {
	var 
...
S.squareRoot = S.sqrt = function () {
	var e,
		...
		g = this.constructor;
	if (u !== 1 || !a || !a[0])
		return new g(!u || (u < 0 && (!a || a[0])) ? Number.NaN : a ? this : 1 / 0);
	for (
		_ = !1,
			u = Math.sqrt(+this),
			u == 0 || u == 1 / 0
...
fe.stringify = (e, t) => typeof e == "string"
		? e
		: Array.isArray(e)
			? e
					.map((r) => fe.stringify(r, t))
					.join("")
			: Qu(e.type)(e.content);
function Qu(e) {
	return wo[e] || Uu;
