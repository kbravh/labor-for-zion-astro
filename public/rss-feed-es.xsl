      ...
      <body>
        <header>
          ...
          <div class="preview-notice">
            <strong>Vista Previa del Feed RSS</strong> - Esta es una vista previa web del feed RSS. Para suscribirte, copia la URL de la barra de direcciones de tu navegador y pégala en tu lector RSS.
          </div>

          <div class="rss-info">
            <h3>¿Qué es RSS?</h3>
            <p>
              RSS (Really Simple Syndication, Sindicación Realmente Simple) es un formato de datos que permite a usuarios y aplicaciones acceder a actualizaciones de sitios web de manera estandarizada y legible por computadora.
            </p>
            <p>
              Al suscribirte a feeds RSS, puedes seguir muchos sitios web diferentes en un solo agregador de noticias. No necesitas crear una cuenta en el sitio que sigues, y el sitio no puede rastrear lo que lees ni mostrarte anuncios.
            </p>
            <p>
              Aprende más sobre RSS en <a href="https://aboutfeeds.com" target="_blank" rel="noopener noreferrer">About Feeds</a>.
            </p>
          </div>
        </header>
