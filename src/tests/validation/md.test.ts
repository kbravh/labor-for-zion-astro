...
const example = {
	...
	description:
		"Learn how to develop Christlike humility through scriptural examples and the power of prayer.",
...
const exampleBracketLink = {
	...
	excerpt:
		"This can be most clearly seen during Christ's first miracle at the wedding feast",
};
