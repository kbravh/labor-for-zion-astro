...
export const metaMap: MetaMap = {
	...
	es: {
		about1:
			"Yo, Karey Higuera, administro este sitio web. Soy programador basado en Indianapolis, Indiana. Soy miembro de la Iglesia de Jesucristo de los Santos de los Últimos Días.",
		about2:
			"Serví una misión para la iglesia desde Abril 2015 - Abril 2017 in la misión Argentina Resistencia. Tengo una esposa y una hija chiquita, y paso la mayoría de mi tiempo trabajando, leyendo, jugando videojuegos, y pasando tiempo con mi familia.",
		contact:
			"Si te gustaría comunicarte conmigo, siéntate libre de mandarme un mensaje a",
		site: "Obrero en Sión",
		description:
